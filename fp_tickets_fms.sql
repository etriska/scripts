...
TITLE,
  ...
  END STATUS,
  CASE
    WHEN a.WORK__BTYPE LIKE '%__b%' THEN REPLACE(a.WORK__BTYPE, '__b',' ')
    WHEN a.WORK__BTYPE LIKE '%__f%' THEN REPLACE(a.WORK__BTYPE, '__f','/') 
    ELSE a.WORK__BTYPE
  END WORK_TYPE, 
  CASE
  ...
  REPLACE(a.DESIRED__BCOMPLETION, '__b', ' ') DESIRED_COMPLETION,
